...
namespace Bodoconsult.App.Avalonia.ReactiveUI.AppStarter;
...
public class AvaloniaStarterUi : BaseAppStarterUi
{
    ...
    /// </summary>
    public AvaloniaStarterUi(IAppBuilder appBuilder, IRxMainWindowViewModel viewModel) : base(appBuilder)
    {
