...
public partial class MenuControlViewModel : ReactiveObject
{
    ...
    /// </summary>
    /// <param name="avaloniaUiMenuBuilder">Current menu builder</param>
    public void LoadMenuBuilder(AvaloniaUiMenuBuilder avaloniaUiMenuBuilder)
    {
        var avaloniaUiMenuBuilder1 = avaloniaUiMenuBuilder;
        avaloniaUiMenuBuilder1.MenuBuiltDelegate = MenuBuiltDelegate;
        ...
        avaloniaUiMenuBuilder1.MenuItemsSource.ToObservableChangeSet()
