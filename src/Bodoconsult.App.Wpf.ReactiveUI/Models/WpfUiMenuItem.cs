...
///// </summary>
//public partial class object : ReactiveObject
//{
//    private readonly ReadOnlyObservableCollection<object> _items;

//    private ObservableCollectionExtended<object> ItemsInternal { get; } = new();
...
//    public object(string header, ReactiveCommand<Unit, Unit>? command)
//    {
//        Header = header;
//        Command = command;
