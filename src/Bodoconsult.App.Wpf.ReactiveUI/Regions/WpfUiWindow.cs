...
//    public WpfUiWindow(Window window, IRegionManager regionManager) : base(window.Name, regionManager)
//    {
//        Window = window;
//    }
...
//    /// <param name="regionManager">Current region manager</param>
//    public WpfUiWindow(Window window, string name, IRegionManager regionManager) : base(name, regionManager)
//    {
//        Window = window;
//    }
