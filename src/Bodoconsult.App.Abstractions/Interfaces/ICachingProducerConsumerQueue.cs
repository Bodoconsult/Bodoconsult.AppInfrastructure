...
/// <summary>
/// Implements a thread-safe generic producer consumer based pattern cachin data using threads: Use it for classes
/// </summary>
public interface ICachingProducerConsumerQueue<T> where T : class
{
    /// <summary>
    /// Cache size
    /// </summary>
