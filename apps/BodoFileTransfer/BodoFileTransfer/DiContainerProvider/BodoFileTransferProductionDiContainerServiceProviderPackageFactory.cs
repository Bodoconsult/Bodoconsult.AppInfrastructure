...
public class BodoFileTransferProductionDiContainerServiceProviderPackageFactory : IDiContainerServiceProviderPackageFactory
{
    /// <summary>
    /// Default ctor
    /// </summary>
    public BodoFileTransferProductionDiContainerServiceProviderPackageFactory(IAppGlobals appGlobals)
    {
