...
/// App global values
/// </summary>
public class Globals : IBodoFileTransferAppGlobals 
{
    ...
    /// </summary>
    public Bodoconsult.App.Abstractions.DependencyInjection.DiContainer DiContainer { get; set; } = new();
    ...
    /// </summary>
    public Bodoconsult.App.Abstractions.Delegates.StatusMessageDelegate StatusMessageDelegate { get; set; }
    ...
    /// </summary>
    public string NumberSchema { get; set; } = "000000";

    /// <summary>
    /// Weeks back to check emails
    /// </summary>
    public int EmailSentDateWeeksBack { get; set; } = 4;

    /// <summary>
    /// File extensions for signature files
    /// </summary>
    public string SignatureFileExtensions { get; set; } = ".ads;.cms";
}