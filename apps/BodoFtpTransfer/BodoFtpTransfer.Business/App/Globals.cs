...
/// App global values
/// </summary>
public class Globals : IBodoFtpTransferAppGlobals 
{
    ...
    /// </summary>
    public string ExcludeDirs { get; set; } = "{logs}{Internet}";

    /// <summary>
    /// File names to exclude from transfer
    /// </summary>
    public string ExcludeFiles { get; set; } = "{thumbs.db}{robots.txt}{.htaccess}";
    ...
    /// <summary>
    /// Local vbase directory to transfer
    /// </summary>
