...
namespace WpfReactiveUiDemoApp.I18N;

/// <summary>
/// Factory to create a fully configured I18N factory using providers directly
/// </summary>
public class WpfReactiveUiDemoAppI18NFactory : BaseI18NFactory
{
    /// <summary>
    ...
    {
        var ass = typeof(WpfReactiveUiDemoAppI18NFactory).Assembly;

        // Set the fallback language
        I18NInstance.SetFallbackLocale("en");

        // Load WPF base package
        var package = new WpfLocalesProviderPackage();
