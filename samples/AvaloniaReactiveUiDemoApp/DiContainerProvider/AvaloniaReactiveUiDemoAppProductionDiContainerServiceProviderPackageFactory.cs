...
/// </summary>
public class AvaloniaReactiveUiDemoAppProductionDiContainerServiceProviderPackageFactory : IDiContainerServiceProviderPackageFactory
{
    /// <summary>
    /// Default ctor
    /// </summary>
    public AvaloniaReactiveUiDemoAppProductionDiContainerServiceProviderPackageFactory(IAppGlobals appGlobals)
    {
    ...
    {
        return new AvaloniaReactiveUiDemoAppAllServicesDiContainerServiceProviderPackage(AppGlobals);
    }
}