...
namespace AvaloniaReactiveUiDemoApp.I18N;

/// <summary>
/// Factory to create a fully configured I18N factory using providers directly
/// </summary>
public class AvaloniaReactiveUiDemoAppI18NFactory : BaseI18NFactory
{
    /// <summary>
    ...
    {
        var ass = typeof(AvaloniaReactiveUiDemoAppI18NFactory).Assembly;
