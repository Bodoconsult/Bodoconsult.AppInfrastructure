...
namespace AvaloniaReactiveUiDemoApp.AppData;

/// <summary>
/// Current implementation of <see cref="IApplicationService"/>
/// </summary>
public class AvaloniaReactiveUiDemoAppService : IApplicationService
{
    ...
    /// Default ctor
    /// </summary>
    public AvaloniaReactiveUiDemoAppService(IAppLoggerProxy appLogger,
