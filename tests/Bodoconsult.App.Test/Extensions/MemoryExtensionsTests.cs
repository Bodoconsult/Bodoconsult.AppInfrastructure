...
[TestFixture]
internal class MemoryExtensionsTests
{
    [Test]
    public void IsEqualTo_EqualValues_ReturnsTrue()
    {
        // Arrange 
        var r1 = new Memory<byte>([0x2, 0x42, 0x6c, 0x75, 0x62, 0x62, 0x3]);
        var r2 = new Memory<byte>([0x2, 0x42, 0x6c, 0x75, 0x62, 0x62, 0x3]);
    ...
    {
        // Arrange 
        var r1 = new Memory<byte>([0x2, 0x42, 0x6c, 0x75, 0x62, 0x62]);
        var r2 = new Memory<byte>([0x2, 0x42, 0x6c, 0x75, 0x62, 0x62, 0x3]);
    ...
    public void IsEqualTo_ValuesWithDifferentContent_ReturnsFalse()
    {
        // Arrange 
        var r1 = new Memory<byte>([0x2, 0x42, 0x6c, 0x75, 0x62, 0x62]);
        var r2 = new Memory<byte>([0x2, 0x42, 0x6b, 0x75, 0x62, 0x62, 0x3]);
